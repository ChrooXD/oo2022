...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("1. hammasratta suurus: " + hammasratas2.suurus);
        System.out.println("1. hammasratta suurus: " + hammasratas3.suurus);
        System.out.println("Minu kella suurus: %.2f", (pendliPikkus + hammasratas1.suurus + hammasratas2.suurus + hammasratas3.suurus));
