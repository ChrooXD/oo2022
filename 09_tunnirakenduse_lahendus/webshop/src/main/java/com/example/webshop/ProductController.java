...
// iga kord kui teen muudatuse, pean tegema backendile restardi
    ...
    @GetMapping("lisa-sona/{sona}") //localhost:8080/saa-sonad
    ...
    @GetMapping("kustuta-s6na/{index}") //localhost:8080/saa-yks-s6na/1
    public String kustutaSona(@PathVariable int index) {
        return s6nad.remove(index); // kustutatud sõna tuleb frondEndi
    }
...
// 404 sellist UELi ei ole
// 400 muutujat ei ostud convertida Bad Request
// 403 forbidden ei saa ligi
// 401 need authentication, saad ligi kui autentid

// 500 v 5xx - Server võtab errori oma süüks